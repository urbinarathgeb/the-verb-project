...
- [ ] **T7.3 — Onboarding «¿Cómo se juega?».** Modal desde el menú con qué es el juego, cómo se juega y los tres modos. Resuelve de paso el pendiente de **D7** sobre el resumen de nivel del menú.
